...
const riderWaiteCards = [
  // ============ 大阿卡纳 Major Arcana (22张) ============
  {
    ...
    translations: {
      en: {
        upright: "A new beginning, embarking on an unknown journey with innocence and trust. Embrace change, let go of fear, and believe the universe will catch you. This is a starting point full of potential.",
  ...
  },
  {
    ...
    translations: {
      en: {
        upright: "You have all the resources needed to achieve your goals. With both willpower and skill, now is the best time to turn ideas into reality.",
        reversed: "Talents are wasted or misused. You may feel inadequate or limited by external conditions. Re-examine your strengths and opportunities."
      }
    }
  },
  {
    ...
    translations: {
      en: {
        upright: "Listen to the voice of inner intuition and the subconscious. Hidden knowledge is about to surface. Quiet your mind—the answer often lies within you.",
        reversed: "Ignoring intuition or over-relying on rationality. You may be deceived by appearances and need to reconnect with inner wisdom and feelings."
      }
    }
  },
  {
    ...
    translations: {
      en: {
        upright: "Abundance, creativity, and maternal care. Enjoy the beauty of the senses, nourish yourself and those around you. This is a time of harmonious abundance.",
        reversed: "Creativity is blocked or there is excessive dependence. You may lose yourself in relationships and need to regain inner balance and independence."
      }
    }
  },
  {
    ...
    translations: {
      en: {
        upright: "Establish order and stability. Use leadership, rational thinking, and discipline to control the situation. Structure is the foundation of success.",
        reversed: "Dictatorial stubbornness or lack of self-discipline. You may face challenges to authority and need to learn flexibility rather than rigid control."
      }
    }
  },
  {
    ...
    translations: {
      en: {
        upright: "Seek traditional wisdom and spiritual guidance. Follow established value systems, learn from trusted mentors, and gain deeper understanding.",
  ...
  },
  {
    ...
    translations: {
      en: {
        upright: "An important choice and alignment of values. Harmonious relationships are developing. Listen to your heart and make choices that align with your true self.",
        reversed: "Disharmony in relationships or conflicting values. You may face difficult choices and need to honestly confront your true feelings."
      }
    }
  },
  {
    ...
    translations: {
      en: {
        upright: "Willpower overcomes obstacles. Move toward your goal with determination, control opposing forces, and victory belongs to you.",
        reversed: "Loss of control or unclear direction. You may encounter obstacles and setbacks. Re-adjust your mindset and strategy to move forward."
      }
    }
  },
  {
    ...
    translations: {
      en: {
        upright: "Inner strength and gentle courage. Overcome difficulties with patience and empathy. True strength comes from inner peace.",
        reversed: "Self-doubt or inner fear. You may feel powerless and need to reconnect with inner confidence and resilience."
      }
    }
  },
  {
    ...
    translations: {
      en: {
        upright: "A time for introspection and solitude. Temporarily withdraw from the noise to seek inner wisdom. Loneliness is a necessary path to growth.",
        reversed: "Excessive isolation or refusing help. You may be escaping reality and need to re-engage with the world and share your light."
      }
    }
  },
  {
    ...
    translations: {
      en: {
        upright: "The transformation of fate and the arrival of opportunity. Accept life's cycles of change. Good luck is turning your way—go with the flow.",
  ...
  },
  {
    ...
    translations: {
      en: {
        upright: "Justice and the law of cause and effect. Your actions will be rewarded accordingly. Stay honest and upright—truth will eventually be revealed.",
  ...
  },
  {
    ...
    translations: {
      en: {
        upright: "The wisdom of sacrifice and waiting. Look at the problem from a different angle. A temporary pause will bring deeper insight and a turning point.",
  ...
  },
  {
    ...
    translations: {
      en: {
        upright: "Ending and transformation. The old must die for the new to be born. Accept the transformation—this is the necessary path to rebirth.",
  ...
  },
  {
    ...
    translations: {
      en: {
        upright: "Balance and moderation. Patiently blend opposing forces. The middle path will bring lasting peace and satisfaction.",
  ...
  },
  {
    ...
    translations: {
      en: {
        upright: "Face your inner shadow and bonds. You may be controlled by material desires or bad habits. Realize that the bonds come from within.",
  ...
  },
  {
    ...
    translations: {
      en: {
        upright: "Sudden transformation and collapse. Old structures must be destroyed to be rebuilt. Though painful, this is a necessary purification process.",
  ...
  },
  {
    ...
    translations: {
      en: {
        upright: "The emergence of hope and inspiration. See the light in the darkness, believe in a beautiful future. This is a time for healing and confidence.",
        reversed: "Lost hope or feeling despair. Need to reconnect with inner faith and find the glimmer in difficult situations."
      }
    }
  },
  {
    ...
    translations: {
      en: {
        upright: "A period of illusion and uncertainty. Trust intuition but be careful of delusions. Hidden fears need to be faced.",
        reversed: "Fears dissipate, truth comes to light. Walk out of confusion, clearly see the essence of things, release inner fears."
      }
    }
  },
  {
    ...
    translations: {
      en: {
        upright: "The arrival of joy and success. Pursue happiness openly. Everything is in its best state, full of vitality.",
  ...
  },
  {
    ...
    translations: {
      en: {
        upright: "Awakening and rebirth. Past actions need to be examined and forgiven. You are called toward a higher mission and new life.",
  ...
  },
  {
    ...
    translations: {
      en: {
        upright: "Completion and fulfillment. A perfect ending of a cycle, achievement and satisfaction. You are ready to welcome a greater journey.",
  ...
  // ============ 小阿卡纳 - 权杖 Wands (14张) ============
  {
    ...
    translations: {
      en: {
        upright: "The spark of creativity and new inspiration. A passionate project is about to begin. Seize this moment full of potential.",
        reversed: "Creativity is blocked or the start is delayed. You may lack confidence or direction. Need to rekindle the inner flame."
      }
    }
  },
  {
  ...
  },
  {
    ...
    translations: {
      en: {
        upright: "Rapid progress and energy flow. Messages or opportunities arrive swiftly. Seize the moment—things are accelerating.",
  ...
  // ============ 小阿卡纳 - 圣杯 Cups (14张) ============
  {
    ...
    translations: {
      en: {
        upright: "A new emotional beginning. The emergence of love, joy, and intuition. Open your heart and accept the gifts of emotion.",
...
// 导出 Map 以便 O(1) 查找
const riderWaiteCardsMap = new Map(riderWaiteCards.map(function(c) { return [c.id, c]; }));
