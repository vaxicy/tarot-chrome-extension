...
const I18N = {
  zh: {
    ...
    donate_qr_tip: '扫码支持，感谢你的鼓励！',
    feedback_hint: '有问题？欢迎反馈 → huangzero2004@gmail.com',
    cat_simple: '入门经典',
    ...
    card_pick_title: '选择你的牌',
    card_pick_hint: '左右滑动浏览牌堆 · 点击抽牌',
    settings_title: '⚙️ 设置',
    settings_hint: '配置 AI 智能解读',
    settings_ai_enable: '启用 AI 智能解读',
    settings_ai_enable_desc: '开启后，结果页可使用 AI 生成更深入的个性化解读',
    settings_provider: 'AI 服务商',
    settings_provider_siliconflow: '硅基流动',
    settings_provider_openai: 'OpenAI',
    settings_provider_custom: '自定义',
    settings_api_key: 'API Key',
    settings_api_base: 'API 地址',
    settings_api_base_hint: '默认即可，系统会自动忽略误填的路径后缀',
    settings_model: '模型',
    settings_test: '测试连接',
    settings_testing: '测试中...',
    settings_test_ok: '连接成功',
    settings_test_no_key: '请先填写 API Key',
    settings_test_bad_key: 'API Key 无效或无权限',
    settings_test_bad_url: 'API 地址有误（404），请检查',
    settings_test_model_missing: '已连接，但所选模型不在该端点列表中，请核对模型名',
    settings_test_network: '网络错误，无法连接到该地址',
    settings_no_history: '不保存历史记录',
    settings_no_history_desc: '开启后，占卜结果不会写入历史记录',
    ai_question_placeholder: '输入你的问题，AI 结合问题解读...',
    ai_followup_placeholder: '继续追问...',
    settings_privacy: 'API Key 仅保存在本地浏览器，请求直接发往你所配置的服务商',
    ai_interpret_btn: 'AI 智能解读',
    ai_reading_title: '✨ AI 深度解读',
  ...
  en: {
    ...
    donate_paypal: 'PayPal',
    donate_qr_tip: 'Scan to support, thank you for your encouragement!',
    feedback_hint: 'Questions? Feel free to reach out → huangzero2004@gmail.com',
    ...
    card_pick_title: 'Choose Your Cards',
    card_pick_hint: 'Swipe to browse · Tap to pick',
    settings_title: '⚙️ Settings',
    settings_hint: 'Configure AI interpretation',
    settings_ai_enable: 'Enable AI Interpretation',
    settings_ai_enable_desc: 'When enabled, the result page can generate deeper personalized readings with AI',
    settings_provider: 'AI Provider',
    settings_provider_siliconflow: 'SiliconFlow',
    settings_provider_openai: 'OpenAI',
    settings_provider_custom: 'Custom',
    settings_api_key: 'API Key',
    settings_api_base: 'API Base URL',
    settings_api_base_hint: 'Default works; mis-pasted path suffixes are stripped automatically',
    settings_model: 'Model',
    settings_test: 'Test Connection',
    settings_testing: 'Testing...',
    settings_test_ok: 'Connected',
    settings_test_no_key: 'Please enter your API Key first',
    settings_test_bad_key: 'API Key is invalid or unauthorized',
    settings_test_bad_url: 'API Base URL is wrong (404), please check',
    settings_test_model_missing: 'Connected, but the selected model is not in this endpoint\'s model list',
    settings_test_network: 'Network error, cannot reach this address',
    settings_no_history: 'Don\'t Save History',
    settings_no_history_desc: 'When enabled, readings will not be saved to history',
    ai_question_placeholder: 'Type your question for a tailored reading...',
    ai_followup_placeholder: 'Ask a follow-up question...',
    settings_privacy: 'Your API Key is stored locally in the browser; requests go directly to the provider you configure',
    ai_interpret_btn: 'AI Interpretation',
    ai_reading_title: '✨ AI Deep Reading',
