...
const I18N = {
  zh: {
    ...
    btn_license: '授权',
    license_title: '授权管理',
    license_input_label: '输入授权码',
    license_input_placeholder: 'XXXX-XXXX-XXXX',
    license_verify: '验证授权码',
    license_verifying: '验证中...',
    license_purchase: '💰 获取授权码',
    license_info: '授权码绑定设备，最多支持 3 台设备同时使用',
    license_status_pro: '✅ 已授权（{type}）',
    license_status_expires: '到期时间：{date}',
    license_status_device: '已绑定设备：{count}/{max}',
    license_error_invalid: '❌ 无效的授权码',
    license_error_network: '❌ 网络错误，请检查连接',
    license_error_expired: '❌ 授权已过期',
    license_error_device_limit: '❌ 授权码已绑定 {max} 台设备，请先在旧设备中解绑',
    license_success: '🎉 授权成功！高级功能已解锁',
    license_type_lifetime: '永久',
    license_type_yearly: '年付',
    cat_self: '自我成长',
  ...
  en: {
    ...
    license_input_label: 'Enter License Key',
    license_input_placeholder: 'XXXX-XXXX-XXXX',
    license_verify: 'Verify License',
    license_verifying: 'Verifying...',
    license_purchase: '💰 Get License Key',
    license_info: 'License key binds to device, supports up to 3 devices',
    license_status_pro: '✅ Licensed ({type})',
    license_status_expires: 'Expires: {date}',
    license_status_device: 'Bound devices: {count}/{max}',
    license_error_invalid: '❌ Invalid license key',
    license_error_network: '❌ Network error, please check connection',
    license_error_expired: '❌ License expired',
    license_error_device_limit: '❌ License already bound to {max} devices, please unbind from old device first',
    license_success: '🎉 License verified! Pro features unlocked',
